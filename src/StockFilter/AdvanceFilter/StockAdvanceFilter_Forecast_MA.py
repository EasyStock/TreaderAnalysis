...
class CStockAdvanceFilter_Forecast_MA(IAdvanceFilterBase):
    ...
    def _calcNewDataFrame(self, df ,percentage):
        ...
        df1 = df1.append({stock_Date:"预测日前", stock_ClosePrice:newClosePrice, stock_MA5:newMA5, stock_MA10:newMA10, stock_MA20:newMA20, stock_MA30:newMA30}, ignore_index=True)
        return df1
